...
(function () {
  ...
  var contacts = [
    { label: '🇸🇬 新加坡 1', phone: '6587400124', disp: '+65 8740 0124' },
    { label: '🇸🇬 新加坡 2', phone: '6513002039666', disp: '+65 1300 2039 666' },
    { label: '🇨🇳 中国 1', phone: '8619964046593', disp: '+86 199 6404 6593' },
    { label: '🇨🇳 中国（主号）', phone: '8618902245387', disp: '+86 189 0224 5387' }
  ];
  ...
  var head =
    ...
    '<div id="wa-multi-panel" role="dialog" aria-label="WhatsApp 联系我们">' +
    '<div id="wa-multi-head">WhatsApp 联系我们<small>点击选择客服号码</small></div>' +
    ...
    '</div>' +
    '<button id="wa-multi-btn" aria-label="打开 WhatsApp 联系列表">' +
